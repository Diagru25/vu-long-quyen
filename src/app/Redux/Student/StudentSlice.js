...
import { fetchAllStudents, addStudent, updateStudent, deleteStudent } from './studentAction';
    ...
    extraReducers: (builder) => {
        ...
        builder
            .addCase(updateStudent.fulfilled, (state, action) => {
                let foundIndex = state.list.findIndex(student => student.key === state.currentStudent.key);
